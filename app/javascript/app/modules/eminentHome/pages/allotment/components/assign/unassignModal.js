...
function unassignModal({System , setSystem}) {
    
    const handleClose = () => setSystem(false);

    const handleModalSystem = () =>{
        setSystem(false)
    }
  return (
    <div>
          ...
          <Box sx={style}>
            ...
            <div>
              <div className="modal-head-123">
                <button className="cross-btn-1" onClick={() => setSystem(false)}>
                  x
                </button>
              </div>
              <div className="modal-body-123-1">
                <div className="modal-1">
                  <h4>Are you sure you want to unassign "Narendra Huda" for this position?</h4>
                </div>
                <div>
                ...
                <div className="modal-4">
                  <button className="modal-btn-sure" onClick={handleModalSystem}>
                    Sure
                  </button>
                </div>
