        ...
        <Box sx={{display: 'flex'}}>
            ...
            >
                ...
                <p className="refineoption">Refine by</p>
                    <p className="clearoption me-4">Clear</p>
                </div>
                <FiltersSidebar/>
                ...
                <Typography className="ms-15-30">
                    ...
                    <div className="tabsDiv d-flex flex-column">
                        <div className="navBar d-flex justify-content-between mt-2">
                            <ul>
                                <li onClick={()=>updateToggle(1)} className={toggle === 1? "opentab" : "closedtab"}>Home</li>
                                <li onClick={()=>updateToggle(2)} className={toggle === 2? "opentab" : "closedtab"}>Allotment</li>
                                <li onClick={()=>updateToggle(3)} className={toggle === 3? "opentab" : "closedtab"}>File Status</li>
                                <li onClick={()=>updateToggle(4)} className={toggle === 4? "opentab" : "closedtab"}>Master of Vacancies</li>
                                <li onClick={()=>updateToggle(5)} className={toggle === 5? "opentab" : "closedtab"}>Slotting</li>
                                <li onClick={()=>updateToggle(6)} className={toggle === 6? "opentab" : "closedtab"}>GOM Management</li>
                            </ul>
