...
import Inputfield from "../../../eminentpersonalityhome/component/inputfield/inputfield";
...
export default function BasicTabs() {
    ...
    if (value === '1') {
        ...
        buttonContent = <>
        <Button onClick={() => setWantToAddNew(true)}>Open modal</Button>
            <Modal
            ...
            >
                ...
                <Modal.Body>
                    <Typography>Drag and Drop Excel file Here </br> Or </br> Click Here to Upload</Typography>
                </Modal.Body>
                <Modal.Footer>
                    <button
                        className="btn"
